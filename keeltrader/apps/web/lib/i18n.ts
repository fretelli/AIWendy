...
export const en = {
  ...
  "auth.reset.missingToken": "Invalid or missing reset token",
  ...
  "auth.reset.requestNew": "Request a new password reset link",
  "auth.reset.success.title": "Password reset successful",
  "auth.reset.success.subtitle": "Your password has been reset",
  "auth.reset.success.body": "You can now log in with your new password.",
  "auth.reset.success.goToLogin": "Go to login",
...
export const zh: Record<MessageKey, string> = {
  ...
  "auth.reset.subtitle": "请输入您的新密码",
  "auth.reset.newPassword": "新密码",
  "auth.reset.confirmPassword": "确认新密码",
  "auth.reset.submit": "重置密码",
  "auth.reset.backToLogin": "返回登录",
  "auth.reset.missingToken": "无效或缺失的重置令牌",
  "auth.reset.passwordMismatch": "两次输入的密码不一致",
  "auth.reset.passwordTooShort": "密码至少需要 8 个字符",
  "auth.reset.error": "重置密码失败",
  "auth.reset.invalidTitle": "无效的重置链接",
  "auth.reset.requestNew": "请求新的密码重置链接",
  "auth.reset.success.title": "密码重置成功",
  "auth.reset.success.subtitle": "您的密码已重置",
  "auth.reset.success.body": "您现在可以使用新密码登录了。",
  "auth.reset.success.goToLogin": "前往登录",
