...
export type ValuationBoard = { metadata: MarketAnalysisMetadata; percentile_window: string; point_in_time?: true; synthetic_substitution: false; items: ValuationItem[] };
export type ValuationHistory = { metadata: MarketAnalysisMetadata; code: string; universe: "broad" | "sw_l1"; requested_limit: number; available_points_total: number; available_start?: string; available_end?: string; point_in_time: true; synthetic_substitution: false; points: Array<{ as_of: string; analysis_version: string; pe?: number; pb?: number; pe_percentile?: number; pb_percentile?: number; activity_percentile?: number; crowding_percentile?: number | null; crowding_status?: string; crowding_reason?: string; crowding_coverage?: number; percentile_change_1m?: number; percentile_change_3m?: number }> };
