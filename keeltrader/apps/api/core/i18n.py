...
_MESSAGES: Final[Mapping[Locale, Mapping[str, str]]] = {
    "en": {
        ...
        "errors.invalid_file_extension": "Invalid file extension. Allowed: {allowed}",
        "errors.image_too_large": "Image dimensions are too large",
    ...
    "zh": {
        ...
        "errors.invalid_file_extension": "文件扩展名无效。允许：{allowed}",
        "errors.image_too_large": "图片尺寸过大",
