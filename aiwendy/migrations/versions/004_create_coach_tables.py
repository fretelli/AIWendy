...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('style', sa.Enum('empathetic', 'disciplined', 'analytical',
                                   'motivational', 'socratic', name='coachstyle'),
                  nullable=False),
        ...
        sa.Column('llm_provider', sa.Enum('openai', 'anthropic', 'local', 'custom',
                                          name='llmprovider'), nullable=True),
        ...
        sa.Column('min_subscription_tier', sa.String(20), nullable=True, default='free'),
    ...
    op.create_table(
        ...
        sa.Column('coach_id', sa.String(50),
                  sa.ForeignKey('coaches.id'), nullable=False),
    ...
    op.create_index('ix_chat_sessions_user_created', 'chat_sessions',
                    ['user_id', 'created_at'])
    op.create_index('ix_chat_sessions_coach_active', 'chat_sessions',
                    ['coach_id', 'is_active'])
