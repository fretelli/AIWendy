...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('preset_id', sa.String(50),
                  sa.ForeignKey('coach_presets.id'), nullable=True),
    ...
    op.create_index('ix_roundtable_sessions_user_created', 'roundtable_sessions',
                    ['user_id', 'created_at'])
    op.create_index('ix_roundtable_sessions_active', 'roundtable_sessions',
                    ['is_active'])
    ...
    op.create_table(
        ...
        sa.Column('session_id', postgresql.UUID(as_uuid=True),
                  ...
                  nullable=False),
        sa.Column('coach_id', sa.String(50),
                  sa.ForeignKey('coaches.id'), nullable=True),
    ...
    op.create_index('ix_roundtable_messages_session_created', 'roundtable_messages',
                    ['session_id', 'created_at'])
    op.create_index('ix_roundtable_messages_turn', 'roundtable_messages',
...
def downgrade():
    ...
    op.drop_index('ix_roundtable_sessions_user_created', table_name='roundtable_sessions')
