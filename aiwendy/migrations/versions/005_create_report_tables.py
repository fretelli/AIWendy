...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('report_type', sa.Enum('daily', 'weekly', 'monthly', 'quarterly', 'yearly',
        ...
        # Generation metadata
        sa.Column('status', sa.Enum('pending', 'generating', 'completed', 'failed', 'sent',
                                    name='reportstatus'), default='pending'),
    ...
    op.create_index('ix_reports_user_period', 'reports',
    ...
    op.create_index('ix_report_templates_type', 'report_templates',
