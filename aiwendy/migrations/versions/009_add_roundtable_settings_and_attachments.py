...
def upgrade():
    ...
    op.add_column("roundtable_sessions", sa.Column("llm_config_id", sa.String(100), nullable=True))
    op.add_column("roundtable_sessions", sa.Column("llm_provider", sa.String(50), nullable=True))
    op.add_column("roundtable_sessions", sa.Column("llm_model", sa.String(200), nullable=True))
    op.add_column("roundtable_sessions", sa.Column("llm_temperature", sa.Float(), nullable=True))
    op.add_column("roundtable_sessions", sa.Column("llm_max_tokens", sa.Integer(), nullable=True))
    ...
    op.add_column(
        "roundtable_sessions",
        sa.Column("kb_max_candidates", sa.Integer(), nullable=True, server_default="400"),
    )

    # roundtable_messages: attachments metadata
    op.add_column("roundtable_messages", sa.Column("attachments", sa.JSON(), nullable=True))
