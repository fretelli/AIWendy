...
- Market is organized as exactly two top-level views—Market/Sectors/Flows and Macro Data—with rates, futures, options, valuation, correlation, and factors kept as in-module drilldowns. Rates exposes provider-native SHIBOR/LPR, historical USD LIBOR/HIBOR, US nominal/real curves, Treasury bills, long-term composite/20Y CMT, and the real long-term average; stopped sources are labeled rather than synthetically extended.
