...
- Macro navigation returns lightweight official-field summaries and the next scheduled China release or awaiting-source state, while each selected GDP/CPI/PPI/M2/social-financing/PMI/rate series lazily loads primary, MoM, YoY, and rolling 10-year percentile histories with explicit official/calculated/not-applicable methodology. PPI drilldown keeps every synchronized official production-material and consumer-goods subseries across YoY, MoM, and accumulated YoY measures.
